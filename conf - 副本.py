...
BLOG_AUTHOR = {"en": "seven", "zh_cn": "七"} # (translatable)
BLOG_TITLE = {"en": "Blog", "zh_cn": "博客"}
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://blog.ov888.com/"
BLOG_EMAIL = "539234@qq.com"
...
POSTS = POSTS + (("stories/*.ipynb", "stories", "story.tmpl"),)
...
# If CATEGORY_ALLOW_HIERARCHIES层次 is set to True, categories can be organized in
